...
目前我的plugin只针对Android平台开发。对于plugin项目我需要同时编写java代码和dart代码，java代码写在`android/src/main/java/com/green/kinsomy/application`目录下,主要工作是接入高德定位sdk，同时和dart代码进行交互，dart代码则在`lib`目录下编写，再次提醒